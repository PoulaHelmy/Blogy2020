var big_image, navbar_initialized, transparent = !0, transparentDemo = !0,
                                   fixedTop = !1, backgroundOrange = !1,
...
function debounce(n, e, t) {
  ...
  return function() {
    ...
    clearTimeout(r),
        r = setTimeout(function() { r = null, t || n.apply(a, o) }, e),
        t && !r && n.apply(a, o)
  }
}
...
$(document).ready(function() {
  ...
  0 != $(".modal").length && $(".modal").appendTo("body"), pk.initSliders(),
  pk.initPopovers(), pk.initNavbarImage(),
  0 != $(".navbar[color-on-scroll]").length &&
      $(window).on("scroll", pk.checkScrollForTransparentNavbar),
  $(".navbar-collapse").click(function() {
    setTimeout(function() {
      1 == pk.misc.navbar_menu_visible &&
          ($("html").removeClass("nav-open"), pk.misc.navbar_menu_visible = 0,
           $("#bodyClick").remove(),
  ...
  768 <= window_width && 0 != $('.page-header[data-parallax="true"]').length &&
        ...
        function() {
          ...
          1 == pk.misc.navbar_menu_visible
              ? ($("html").removeClass("nav-open"),
                 pk.misc.navbar_menu_visible = 0, $("#bodyClick").remove(),
                 setTimeout(function() { $toggle.removeClass("toggled") }, 550))
              : (setTimeout(function() { $toggle.addClass("toggled") }, 580),
                 div = '<div id="bodyClick"></div>',
                 $(div).appendTo("body").click(function() {
                   $("html").removeClass("nav-open"),
                       pk.misc.navbar_menu_visible = 0, setTimeout(function() {
    ...
    pk = {
      ...
      initNavbarImage : function() {
        ...
        $(window).width() < 991 || $("body").hasClass("burger-menu")
            ? null != o && a.css("background", "url('" + o + "')")
                               .removeAttr("data-nav-image")
                               .css("background-size", "cover")
                               .addClass("has-image")
            : null != o && a.css("background", "")
      ...
      initSliders : function() {
        if (0 != $("#sliderRegular").length) {
          ...
          noUiSlider.create(
              a, {start : [ 5e3 ], range : {min : [ 2e3 ], max : [ 1e4 ]}})
        }
        if (0 != $("#sliderDouble").length) {
          var o = document.getElementById("sliderDouble");
          noUiSlider.create(
              o,
              {start : [ 20, 80 ], connect : !0, range : {min : 0, max : 100}})
        }
      },
    ...
    demo = {
      initPickColor : function() {
        $(".pick-class-label").click(function() {
          var a = $(this).attr("new-class"),
              o = $("#display-buttons").attr("data-class"),
              n = $("#display-buttons");
          if (n.length) {
            var e = n.find(".btn");
            e.removeClass(o), e.addClass(a), n.attr("data-class", a)
          }
        })
      }
    };
