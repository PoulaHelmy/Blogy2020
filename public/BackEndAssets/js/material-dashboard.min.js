...
var breakCards = !0, searchVisible = 0, transparent = !0, transparentDemo = !0,
    fixedTop = !1, mobile_menu_visible = 0, mobile_menu_initialized = !1,
    toggle_initialized = !1, bootstrap_nav_initialized = !1, seq = 0,
    delays = 80, durations = 500, seq2 = 0, delays2 = 80, durations2 = 500;
function debounce(n, i, t) {
  var r;
  return function() {
    var e = this, a = arguments;
    clearTimeout(r),
        r = setTimeout(function() { r = null, t || n.apply(e, a) }, i),
        t && !r && n.apply(e, a)
  }
}
$(document).ready(function() {
  $("body").bootstrapMaterialDesign(),
      $sidebar = $(".sidebar"), md.initSidebarsCheck(),
      window_width = $(window).width(), md.checkSidebarImage(),
        ...
        function() {
          if ($toggle = $(this), 1 == mobile_menu_visible)
            ...
            0 != $("body").find(".main-panel").length
                ...
                setTimeout(function() { e.addClass("visible") }, 100),
                e.click(function() {
                  $("html").removeClass("nav-open"),
                      mobile_menu_visible = 0, e.removeClass("visible"),
                      setTimeout(function() {
    ...
    md = {
      ...
      checkSidebarImage : function() {
        $sidebar = $(".sidebar"), image_src = $sidebar.data("image"),
        void 0 !== image_src &&
            (sidebar_container =
      ...
      initDashboardPageCharts : function() {
        if (0 != $("#dailySalesChart").length ||
          ...
          var e = new Chartist.Line("#dailySalesChart", dataDailySalesChart,
                                    optionsDailySalesChart);
      ...
      checkScrollForTransparentNavbar : debounce(
          function() {
            260 < $(document).scrollTop()
                ? transparent &&
                      (transparent = !1, $(".navbar-color-on-scroll")
                                             .removeClass("navbar-transparent"))
                : transparent ||
                      (transparent = !0, $(".navbar-color-on-scroll")
            ...
            mobile_menu_initialized
                ...
                : (console.log("intra"),
                   $navbar = $("nav")
                                 ...
                                 .children(".navbar-nav"),
                   mobile_menu_content = "", nav_content = $navbar.html(),
                   nav_content = '<ul class="nav navbar-nav nav-mobile-menu">' +
                                 nav_content + "</ul>",
                   navbar_form =
                       0 != $("nav").find(".navbar-form").length
                           ? $("nav").find(".navbar-form")[0].outerHTML
                           : null,
                   $sidebar_nav = $sidebar_wrapper.find(" > .nav"),
                   $nav_content = $(nav_content), $navbar_form = $(navbar_form),
      ...
      startAnimationForBarChart : function(e) {
        e.on("draw", function(e) {
          "bar" === e.type && window.matchMedia("(min-width: 900px)").matches &&
              (seq2++, e.element.animate({
                opacity : {
                  begin : seq2 * delays2,
                  dur : durations2,
                  from : 0,
