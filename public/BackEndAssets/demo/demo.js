demo = {
  initDocumentationCharts : function() {
    if ($('#dailySalesChart').length != 0 &&
      ...
      var animationHeaderChart = new Chartist.Line(
          '#websiteViewsChart', dataDailySalesChart, optionsDailySalesChart);
    }
  },
  ...
  initGoogleMaps : function() {
    ...
    var mapOptions = {
      zoom : 13,
      center : myLatlng,
      scrollwheel : false, // we disable de scroll over the map, it is a really
                           // annoing when you scroll through page
      styles : [
    ...
    var marker =
        new google.maps.Marker({position : myLatlng, title : "Hello World!"});
