            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                <div class="card card-stats">
                    <div class="card-header card-header-warning card-header-icon">
                        ...
                        <h3 class="card-title" >
                            <small rel="tooltip"   data-original-title="Number Of Admins">{{$numAdmins}}</small>
                        </h3>
                    </div>
                    <div class="card-footer">
                        <div class="stats">
                            ...
                            <a href="{{ route('users.index',['role'=>'admin'])}}" class="warning-link"  rel="tooltip"   data-original-title="Admins Control">Control</a>
                ...
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            ...
                            <a href="{{ route('skills.index') }}" class="info-link"  rel="tooltip"   data-original-title="Roles Control">Control</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-stats">
                    ...
                    <div class="card-footer">
                        <div class="stats">
                            ...
                            <a href="{{ route('skills.index') }}" class="info-danger"  rel="tooltip"   data-original-title="Permissions Control">Control</a>
                        </div>
                    </div>
                </div>
            </div>
